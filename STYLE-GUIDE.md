# Gobble Style Guide
 > Please read the guidelines below prior to submitting any pull request with code.
 > For any details regarding ES6 or topics not covered here, consult the [Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript).
